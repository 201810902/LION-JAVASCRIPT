...
const shopOrder = {
    ...
    menu: [
        ...
        { name: '곰곰 삼계탕', price: 12000, count: 1 },
        { name: '곰곰 해장국', price: 8000, count: 1 },
    ],
    // totalPrice: function () {
    totalPrice() {//forEach로 해보자..
        // let total = 0;
        //*화살표 함수로 쓰기
        ...
        return this.menu.reduce((acc, item) => (item.price * item.count), 0)
    }
};

//reduce 사용하기

//*이렇게 해야 shopOrder를 통해서 주문한 총 금액이 나온다~
...
//화살표 함수가 왜 문제일까?
//this가 window가 되어버린다. 화살표함수는 this 자체를 바인딩하지 않는다. 
//상위컨텍스트를 찾는다. 
